...
<head>
    ...
    <style>
        ...
        .top-content {
            background-image: url('images/social_logo.jpg');
    ...
    <!-- favigon -->
    <link rel="shortcut icon" href="social_logo.jpg" type="image/x-icon">
...
<body>
    ...
    <div class="top-content">
        <h1 style="font-size:35px;">Welcome to Synergy, share your moments with friends!</h1>
    ...
    <footer>            
        <div class="footer"> 
            ...
            <p> ©2024 All Rights Reserved <BR><U></U></p>
        </div>
    </footer>
